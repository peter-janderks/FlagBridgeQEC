...
from flagbridgeqec.circuits import cir_steane_4a, cir_steane_5a, cir_steane_6a
...
class Check_FT(object):
    ...
    def ft_circuit(self):
        ...
        if self.cir_index == '4a':
            timestps.extend([cir_steane_4a(1),cir_steane_4a(2),
                             cir_steane_4a(3),cir_steane_4a(4)])
            self.x_ancillas = set((8,9,10,11))
            self.z_ancillas = set((80,90,100,110))
        elif self.cir_index == '5a':
            timestps.extend([cir_steane_5a(1),cir_steane_5a(2),
                             cir_steane_5a(3),cir_steane_5a(4)])
            self.x_ancillas = set((80,90,100,110,120))
            self.z_ancillas = set((8,9,10,11,12))
        elif self.cir_index == '6a':
            timestps.extend([cir_steane_6a(1),cir_steane_6a(2),
                             cir_steane_6a(3),cir_steane_6a(4)])
    ...
    def circuit_and_statistics(self):
        ...
        #        flat_circuit= (flatten(four_circuit_halves))
#        print(flatten(four_circuit_halves))
